...
\begin{figure}[H]
\centering
\subfloat{\includegraphics[width=.45\linewidth]{google_raspi_kit}}
\qquad
\subfloat{\includegraphics[width=.45\linewidth]{aiy}}
...
\bibitem{book} Michael Weigend, {\em Raspberry Pi für Kids}, 2. Auflage, 2016.
\end{thebibliography}
